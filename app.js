...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var threeProd = multiply(multiply(a, b)[0], c)[0];
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + threeSum + '.';
  var prodMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + threeProd + '.';
  return [threeSum, threeProd, sumMessage, prodMessage];
}
...
function sumArray(testArray){ //eslint-disable-line
  var out1 = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var outMessage = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + out1 + ' is their sum.';
  return [out1, outMessage];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var out1 = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  var outMessage = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + out1 + '.';
  return [out1, outMessage];
}
